...
const contentItem1 = document.querySelector(".info-list-content-item");
...
td5.innerHTML = `<div>
                    <a href=${bodyFive.zh.link}>${bodyFive.zh.text}</a>
                  </div>`;
...
td10.innerHTML = `<div>
                    <a href=${body15.zh.link}>${body15.zh.text}</a>
                  </div>`;
...
td20.innerHTML = `<div>
                    <a href=${body20.zh.link}>${body20.zh.text}</a>
                  </div>`;
